...
func (_m *DBFunctions) AllPagesInCollection() ([]Models.Webpage, error) {
	ret := _m.Called()
...
func (_m *DBFunctions) Search(keys []string) ([]Models.Webpage, error) {
	ret := _m.Called(keys)
...
func (_m *DBFunctions) UploadWebpage(webpage *Models.Webpage) (*mongo.InsertOneResult, error) {
